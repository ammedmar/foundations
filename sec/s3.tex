...
\begin{remark}\label{R: pullback representative}
	...
	\begin{equation*}
		...
		\end{tikzcd}
	\end{equation*}
	But, as we have observed in \cref{D: tautological co-orientation}, diffeomorphisms come equipped with tautological co-orientations, and so a co-orientation of $P \to M$ determines\index{co-orientaton!of pullback!equivalence across realizations} a unique co-orientation of $P' \to M$ by composition and vice versa.
...
\begin{lemma}\index{co-orientability!of extern product}
