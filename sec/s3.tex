...
\begin{definition}\label{D: tautological co-orientation}\index{co-orientation!tautolocigal}
...
\begin{proposition}[Mixed associativity 1]\label{P: OC mixed associativity}
...
To attempt to avoid confusion, let us consider $V$ and $W$ given as oriented, and we will write $V \times_M^o W$ for the fiber product orientation of \cref{S: orientations} and $V \times_M^c W$ for $(\hat V \times_M \hat W)\,\check{\vrule height1.3ex width0pt}$.
