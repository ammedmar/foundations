...
Thus all expressions such as $\beta_M = \beta_V \wedge \beta_W$ should be interpreted as equality of equivalence classes. Of course over a point $x \in M$, we identify the oriented basis $(e_1,\ldots, e_m)$ of $T_xM$ with the form $e_1 \wedge \cdots \wedge e_m$. 
