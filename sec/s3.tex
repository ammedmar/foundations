...
\begin{proof}
	...
	Finally, as $f$ and $g$ are proper and transverse, there is an $\epsilon$ so that $H(-,t)$ and $g$ will be transverse for $0 \leq t \leq \epsilon$ by stability of transversality\footnote{See \cite[Theorem 1.6]{GuPo74} for the case where one manfiold is compact and the other is embedded. A proof for the current situation is given within our proof of \cref{T: transverse complex}, below.}.
