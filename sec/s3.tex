...
\begin{notation}\label{N: hat check}
	...
	If $W$ comes equipped with an orientation, we may write $\hat W$ to refer to $W$ with the induced co-orientation on $g$.
	If $W$ (technically the map $g \colon W \to M$) comes equipped with a co-orientation, we may write $\check W$ to refer to $W$ with its induced orientation.
