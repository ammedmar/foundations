...
\begin{example}\label{E: manifold decomposition}
	Suppose we have a smooth map $\varphi \colon W \to \R$ and that $0$ is a regular value of $\varphi$, meaning in this case that $\varphi$ is transverse to the inclusion of $0$ into $\R$.
	...
	We further suppose $0$ is a regular value for $\phi$ and for $\phi g$.
	In the latter case, we mean that $\phi g$ is transverse to the inclusion of $0$ into $\R$.
