...
\begin{definition}\label{D: connecting}
	Suppose that $U$, $V$, and $U \cap V$ are non-empty open subsets of a manifold without boundary $M = U \cup V$ and that $\uW \in H^k_\Gamma(U \cap V)$ is represented by $r_W \colon W \to U \cap V$.
...
\begin{lemma}\label{L: different point}
	Suppose that $U$, $V$, and $U \cap V$ are non-empty open subsets of a manifold without boundary $M = U \cup V$.
