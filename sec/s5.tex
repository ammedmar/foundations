...
By the same example, a generator of $H^0_{\Gamma}(S^n)$ is represented by the oriented identity map $\id \colon S^n \to S^n$, although the argument there for general closed, oriented manifolds relies on results we have not yet reached.
