...
Although we use $\phi^{-1}(0)$ in our construction of $\delta$, it will be useful in our arguments to allow our regular value to be anywhere in $(-p,p)$, and we immediately work in this generality.
...
\begin{lemma}
	...
	Then $W^p = \phi^{-1}(p) \times_{U \cup V} W$ is an element of $PC^*_\Gamma(U \cup V)$ with boudnary in $Q^*(U \cup V)$, so it represents an element of $H^*_\Gamma(U \cup V)$.
\end{lemma}
...
\begin{lemma}\label{L: different point}
	...
	Let $p, q\in (-1/2,1/2)$ be any points such that $\phi r_W$ is transverse to the inclusions of $p$ and $q$ into $(-1/2,1/2)$, and let $W^p$ and $W^{q}$ be the fiber products $\phi^{-1}(p) \times_M W$ and $\phi^{-1}(q) \times_{U \cup V} W$ considered as elements of  $PC^*_\Gamma(U \cap V)$.
