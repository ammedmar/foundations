...
\begin{proof}[Proof of \cref{T: transverse complex}]
	...
	Also as in \cref{S: co-oriented homotopy}, for the co-oriented case we have $\bd Y = W' \sqcup -W \sqcup B$, where $B$ is the pre(co)chain $\bd W \times I \xr{H\circ (r_{\bd W} \times \id_I)} M$ (cf. the proof of \cref{C: homotopy}).
