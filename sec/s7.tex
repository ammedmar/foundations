...
In this section, we gather together several developments that are available now that we have proven that arbitrary cochain can be made transverse in \cref{T: transverse reps}.

\subsubsection{Transverse complexes}\label{S: product pullbacks}
...
In this case, $C^*_{\Gamma \pf f}(M) = C^*_{\Gamma \pf X}(M)$.
...
\subsubsection{The Kronecker pairing and the Universal Coefficient Theorem for geometric cohomology}\label{S: kronecker}
