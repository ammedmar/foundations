...
In this section, we consider $f^*$ as a partially-defined map of cochain complexes $C^*_\Gamma(M) \to C^*_\Gamma(N)$.
In general, $f^*$ will not be fully defined, as we cannot form pullbacks of cochains that are not transverse to $f$.
...
\begin{proposition}\label{P: trans to f}
	Given a smooth map from a manifolds with corners to a manifold without boundary $f \colon N \to M$, the set $C^*_{\Gamma \pf f}(M)$ is a subcomplex of $C^*_{\Gamma}(M)$.
