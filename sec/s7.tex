...
\begin{definition}\label{D: cochain trans}\index{transversality!simple|textbf}\index{geometric cochain!simply transverse|textbf}
	...
	We call the data of such a pair $(V,W)$ a \textbf{simple transverse representation}\index{simple transverse representation|textbf} for the pair $(\uV,\uW)$.
...
\begin{definition}\label{D: cochain products}
	...
	If $M$ is oriented and $\uV,\uW \in C_*^\Gamma(M)$ are simply transverse, we define the \textbf{intersection product}\index{intersection product|textbf}\index{geometric chain!intersection product product} $\uV \bullet \uW \in C_*^\Gamma(M)$ by $V \times_M W$ for some simple transverse representation $(V,W)$.
...
\subsubsection{Boundary formulas}\index{cup product!boundary formulas}\index{cap product!boundary formulas}\index{intersection product!boundary formulas}\index{exterior product!boundary formulas}
...
\begin{center}\index{cup product!is diagonal pullback of exterior product}\index{exterior product!is cup product of pullbacks}
	\begin{tabular}{|l|c|l|}
		\hline
...
\begin{proposition}\label{P: perturb transverse to map}\index{tranversality!Transversality Theorem!universal}
...
\begin{definition}\label{D: transverse to map}\index{geometric cochain!transverse to a map|textbf}
