...
\begin{theorem}[Transversality Theorem]\label{T: GP transversality}\index{transversality!Transversality Theorem}
...
\begin{theorem}\label{T: homotopy trans}\index{transversality!Transversality Theorem}
