...
\begin{theorem}\label{T: basic trans}\index{tranversality!Transversality Theorem}
...
\begin{theorem}\label{T: homotopy trans}\index{tranversality!Transversality Theorem}
