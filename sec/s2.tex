...
\greg{The closest point characterization of the map is not necessarily correct when $Y$ is not compact. Need to prove that $|\pi(x)-x|$ can still be controlled. Going to look at tubular neighborhood proof in Lee. Note tubular neighbohroods should be sufficient for transversality arguments.}
