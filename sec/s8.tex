...
We claim that, using this choice of generator to identify $H^2_\Gamma(S^3-L)$ with $\Z$, the cup product $\underline{\mr S_1} \uplus \underline{\mr S_2}$ represents the linking number of $L_1$ and $L_2$, where we use the second (of eight!) characterization of linking numbers given by Rolfsen in \cite[Section 5D]{Ro90}.\index{linking number}
