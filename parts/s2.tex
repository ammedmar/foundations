...
% GBF: no, but "ordinary transverse" is used a few times. So I think the real issue is to just call it "ordinary" transverse, even though I'm not sure which one is the better grammatically. In retrospect, I think this is actually bad terminology. I'll email you and Dev.
...
\begin{remark}\label{R: multiproducts}
	...
	The upshot of all this is that when considering situations involving fiber products of more than two maps, we shall have to be careful to assume all needed transversality conditions, rather than having some of them follow from a smaller set of transversality conditions as in the linear case.
\end{remark}
