...
\begin{proof}[Proof of \cref{L: pullback co well defined}]
	...
	Next, suppose we are given an embedding $e: V\into M \times \R^N$ and extend it to $e' = (e,0) \colon V\into M \times \R^N \times \R^n$.
	...
	Next suppose that $e_0: V \to M \times R^{N_0}$ and $e_1 \colon V \to M \times R^{N_1}$ are any two embeddings over $f$.
...
\begin{proof}
	...
	In the construction of the pullback co-orientation for $(\bd V) \times_M W$, we can take $e:\bd V \to M \times \R^N$ to be the restriction of the $e \colon V \to M \times \R^N$ used to co-oriented $P$.
...
\begin{proposition}\label{P: exterior associativity}
	Let $f \colon V \to M$, $g \colon W \to N$, and $h:X \to Q$ be co-oriented maps of manifolds with corners.
