...
The special case of fiber products with $f \colon V \to M$ and $g:W\to M$ embeddings or, a bit more generally, immersions, is always of particular interest, especially for developing intuition.
...
More specifically, if $f \colon V \to M$ and $g:W\to M$ are transverse smooth maps from manifolds with corners to a manifold without boundary and $f$ is co-oriented, we define a co-orientation of the pullback $f^*:V\times_MW\to W$.
...
\begin{lemma}\label{L: co-orientable pullback}
	Suppose $f \colon V \to M$ and $g:W\to M$ are transverse maps of manifolds with corners to a manifold without boundary.
	Then:
	\begin{enumerate}
...
\begin{corollary}
	If $f \colon V \to M$ and $g:W\to M$ are transverse and co-orientable, their fiber product $V\times_MW \to M$ is also co-orientable.
\end{corollary}
...
\begin{remark}\label{R: co-or restriction or switch}
	It follows from the definition that reversing the co-orientation of $f \colon V \to M$ reverses the co-orientation of $f^*:V\times_MW\to W$.
...
\begin{proposition}[Leibniz rule]\label{leibniz}
	Let $f \colon V \to M$ and $g:W\to M$ be transverse maps from manifolds with corners to a manifold without boundary, and suppose $f$ co-oriented.
...
\begin{proposition}\label{P: graded comm}
	Suppose $f \colon V \to M$ and $g:W\to M$ are transverse co-oriented maps from manifolds with corners to a manifold without boundary.
...
\begin{example}\label{E: embedded}
	...
	Let $f \colon V \to M$ and $g:W\to M$ be transverse maps from manifolds with corners to a manifold without boundary.
...
\begin{lemma}\label{L: make full}
	Let $f \colon V \to M$ and $g:W\to M$ be transverse proper maps from manifolds with corners to a manifold without boundary.
...
\begin{proposition}\label{P: oriented interchange}
	Suppose $f \colon V \to M$ and $g:W\to M$ are transverse maps of oriented manifolds with corners to an oriented manifold without boundary and similarly for $h:X\to N$ and $k:Y\to N$.
	Then
...
\begin{corollary}\label{C: fiber natural pullback}
	Suppose $f \colon V \to M$ and $g:W\to M$ are transverse co-oriented maps of manifolds with corners to a manifold without boundary, that $N$ is a manifold with corners, and that $h:N\to M$ is transverse to $f$, $g$, and $f\times_M g$.
	Then
...
\begin{corollary}[Associativity of co-oriented fiber products]\label{C: fiber assoc}
	Suppose $f \colon V \to M$, $g:W\to M$, and $h:X\to M$ are co-oriented maps from manifolds with corners to a manifold without boundary such that the following pairs are transverse (see \cref{R: multiproducts}): $(V,W)$, $(W,X)$, $(V\times_MW,X)$, and $(V,W\times_M X)$.
...
\begin{corollary}\label{C: criss cross}
	Suppose $f \colon V \to M$ and $g:W\to M$ are transverse co-oriented maps from manifolds with corners to a manifold without boundary and similarly for $h:X\to N$ and $k:Y\to N$.
...
\begin{proposition}\label{P: Leibniz cap}
	Let $f \colon V \to M$ and $g:W\to M$ be transverse maps of manifolds with corners to a manifold without boundary.
...
\begin{proposition}\label{P: cap of immersions}
	Let $f \colon V \to M$ and $g:W\to M$ be transverse embeddings from manifolds with corners to a manifold without boundary.
	Suppose $f$ is co-oriented and $W$ is oriented.
...
\begin{proposition}[Mixed associativity]\label{P: OC mixed associativity}
	Let $f \colon V \to M$ and $g:W\to M$ be co-oriented maps from manifolds with corners to a manifold without boundary.
...
Suppose $f \colon V \to M$ and $g:W\to M$ are two transverse co-oriented maps from manifolds with corners to a manifold without boundary.
...
\begin{proposition}\label{P: compare cup and intersection orientations}
	Let $f \colon V \to M$ and $g:W\to M$ be transverse co-oriented maps from manifolds with corners to an oriented manifold without boundary or, equivalently, suppose $V$, $W$, and $M$ all oriented.
...
\begin{lemma}
	Let $f \colon V \to M$ and $g:W\to M$ be transverse co-oriented maps from manifolds with corners to an oriented manifold without boundary.
...
\begin{lemma}
	Let $f \colon V \to M$ and $g:W\to M$ be transverse maps from oriented manifolds with corners to an oriented manifold without boundary.
