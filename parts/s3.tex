...
\begin{proof}
	...
	Then define $e \colon W \into  M \times \R^N$ by $e(x) = (g(x),j(x))$ and $\pi:M \times \R^N \to M$ the projection.
	Clearly $\pi e = g$.
...
\begin{definition}\label{D: boundary co-orientation}
	...
	If $g \colon W \to M$ is co-oriented, the \textbf{induced co-orientation} or \textbf{boundary co-orientation} of the composition $gi_{\partial W}$ is the composition of the standard co-orientation of $i_{\bd W}$ with the given co-orientation of $g \colon W \to M$.
...
\begin{lemma}\label{L: Quillen product co-orientation}
	...
	Consider Quillen co-orientations representing $f$ and $g$ via embeddings $e_V:V\into M \times \R^a$ and $e_W \colon W \into  N \times \R^b \to N$ with $a$ and $b$ even.
...
\begin{proof}
	...
	As in \cref{L: Quillen product co-orientation},we consider Quillen co-orientations representing $f$ and $g$ via embeddings $e_V:V\into M \times \R^a$ and $e_W \colon W \into  N \times \R^b \to N$ with $a$ and $b$ even.
