...
So if the differential of $r_W$ has nontrivial kernel everywhere so will the derivative of any pullback with $r_W$.
\end{proof}
...
The \textbf{essential decomposition} of $V$ is the unique decomposition of $V$ into essential, trivially inessential, and nontrivially inessential components,
